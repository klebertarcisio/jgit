...
public class CommitCommandTest extends RepositoryTestCase {
	...
	private static void addUnmergedEntry(String file, DirCacheBuilder builder) {
		DirCacheEntry stage1 = new DirCacheEntry(file, DirCacheEntry.STAGE_1, FileMode.REGULAR_FILE);
		DirCacheEntry stage2 = new DirCacheEntry(file, DirCacheEntry.STAGE_2, FileMode.REGULAR_FILE);
		DirCacheEntry stage3 = new DirCacheEntry(file, DirCacheEntry.STAGE_3, FileMode.REGULAR_FILE);
		builder.add(stage1);
		builder.add(stage2);
		builder.add(stage3);
	}
