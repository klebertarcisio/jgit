			...
			while (treeWalk.next()) {
				...
				if (pos >= 0) {
					...
					if (fTree != null) {
						...
						// disk
						final DirCacheEntry dcEntry = new DirCacheEntry(path, fTree.getIndexFileMode(dcTree));
					...
					if (hTree != null) {
						// create a new DirCacheEntry with data retrieved from
						// HEAD
						final DirCacheEntry dcEntry = new DirCacheEntry(path, hTree.getEntryFileMode());
